...
<head>
    <meta charset="UTF-8">
    <title>Register - Moorthy Shop</title>
...
<body class="bg-gray-50">
    ...
    <section class="min-h-screen flex items-center justify-center py-12">
        <div class="bg-white p-8 rounded-xl shadow-lg w-full max-w-md">
            <h2 class="text-3xl font-bold text-center text-green-600 mb-8">Register</h2>
            ...
            <form method="POST">
                <div class="mb-4">
                    ...
                    <input type="text" name="nama" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-green-500">
                </div>
            ...
            <p class="text-center mt-4 text-gray-600">
                Sudah punya akun? <a href="login.php" class="text-green-600 font-semibold hover:underline">Login di sini</a>
            </p>
        </div>
    </section>
</body>
